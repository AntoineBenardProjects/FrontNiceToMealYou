...
export const invalidInputRegisterComponent: InputInfos = {
    color: "var(--white)",
...
export const autocompleteInputInfosEditComponent: AutocompleteInfos = {
    textColor: 'var(--white)',
...
export const normalInputFilter: InputInfos = {
    ...
    borderColorActive: "transparent",
    hoverBackgroundColor: "linear-gradient(rgba(255,255,255,0.5),rgba(255,255,255,0.5))",
    hoverTextColor: "var(--black)",
    hoverBorderColor: "transparent",
}
export const searchInputFilter: InputInfos = {
    color: "var(--black)",
    placeholderColor: "var(--black)",
    placeholderColorActive: "var(--black)",
...
export const autocompleteInfosFilter: AutocompleteInfos = {
    textColor: 'var(--black)',
    textColorActive: 'var(--black)',
    backgroundColor: 'white',
    backgroundColorActive: 'var(--white)'
}

export const tableInputInfosAdminComponent: InputInfos = {
    color: 'var(--black)',
    hoverTextColor: 'var(--black)',
    placeholderColor: 'var(--black)',
    placeholderColorActive: 'var(--black)',
...
export const searchInputInfosAdminComponent: InputInfos = {
    color: 'var(--white)',
    hoverTextColor: 'var(--white)',
    placeholderColor: 'var(--white)',
    placeholderColorActive: 'var(--white)',
...
export const searchInputSelectPlace: InputInfos = {
    color: "var(--black)",
    placeholderColor: "var(--black)",
    placeholderColorActive: "var(--black)",
    backgroundColor: "var(--white)",
...
export const autocompleteInfosSelectPlace: AutocompleteInfos = {
    textColor: 'var(--black)',
    textColorActive: 'var(--black)',
    backgroundColor: 'white',
    backgroundColorActive: 'var(--white)'
